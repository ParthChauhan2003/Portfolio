                  ...
                  <section className="pb-12">
                    <div className={`p-10 rounded-[40px] text-center space-y-8 border ${darkMode ? 'bg-white/5 border-white/10 text-white' : 'bg-slate-50 border-slate-200 text-slate-900 shadow-sm'}`}>
                      ...
                      <div className="flex justify-center gap-6 pt-4">
                        <MagneticButton>
                          <a href="https://www.linkedin.com/in/parth-chauhan-7a79131ba" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl border border-current opacity-40 flex items-center justify-center transition-colors hover:opacity-100 hover:text-blue-600 active:opacity-100 active:text-blue-600 cursor-pointer">
                            <Linkedin size={20} />
                          </a>
                        </MagneticButton>
                        <MagneticButton>
                          <a href="mailto:Parthc004@gmail.com" className="w-12 h-12 rounded-2xl border border-current opacity-40 flex items-center justify-center transition-colors hover:opacity-100 hover:text-pink-500 active:opacity-100 active:text-pink-500 cursor-pointer">
                            <Mail size={20} />
                          </a>
                        </MagneticButton>
                        <MagneticButton>
                          <a href="https://github.com/yourprofile" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl border border-current opacity-40 flex items-center justify-center transition-colors hover:opacity-100 hover:text-slate-800 dark:hover:text-white active:opacity-100 active:text-slate-800 dark:active:text-white cursor-pointer">
                            <Github size={20} />
                          </a>
                        </MagneticButton>
                        <MagneticButton>
                          <a href="https://wa.me/919664639533?text=Hello+Parth,+I+visited+your+QA+Portfolio+and+would+like+to+discuss+a+project." target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl border border-current opacity-40 flex items-center justify-center transition-colors hover:opacity-100 hover:text-[#2db742] active:opacity-100 active:text-[#2db742] cursor-pointer">
