...
export const Projects: React.FC<ProjectsProps> = ({ darkMode }) => {
  return (
    <section id="projects" className={`py-24 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className={`text-3xl font-medium tracking-tight mb-6 ${darkMode ? 'text-white' : 'text-gray-900'}`}>Featured Projects</h2>
